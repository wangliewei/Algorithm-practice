...
/*
已知一颗没有重复节点的二叉树，给定其中序和先序遍历数组，返回后序遍历数组
如果不要求没有重复节点，那么可能得到的后序不唯一
...
public class PreAndInArrayToPosArray {
    ...
    //  L1...R1 = L2...R2 = L3...R3  三个子数组的元素数量相等
    public static void process1(
        ...
        //下面表示不止一个数了，先直接把先序的第一个数填到后序的最后一个数
        pos[R3] = pre[L1];
    ...
    //此方法的复杂度是O(N)，为最优解
    //改进的地方在于用空间换时间，给中序数组建一张map，查询的时候用map直接O(1)时间找到
